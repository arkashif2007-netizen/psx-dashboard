  ...
  return (
    <div className="page-content">
      ...
      <div style={{ marginBottom: 20 }}>
        <h1 style={{ fontSize: 28, margin: 0, fontFamily: 'Space Grotesk, sans-serif' }}>Board Meetings</h1>
        <p style={{ color: 'var(--text-muted)', marginTop: 4 }}>Upcoming board meetings and corporate events.</p>
      </div>
      ...
      <div className="glass-card-static" style={{ 
        ...
        <p style={{ color: 'var(--text-muted)', maxWidth: 400, lineHeight: 1.6 }}>
          The global board meetings calendar is being aggregated and will be launched soon!
        </p>
      </div>
    </div>
  );
